...
public class DeviceActivityServiceImpl extends ServiceImpl<DeviceActivityMapper, DeviceActivity>
    ...
    public IPage<DeviceActivity> getRecentActivities(Integer pageNum, Integer pageSize,
                                                   Long deviceId, List<Integer> activityTypes, Long userId) {
        Page<DeviceActivity> page = new Page<>(pageNum, pageSize);
        return baseMapper.selectRecentActivities(page, deviceId, activityTypes, userId);
    }

    @Override
    public List<DeviceActivity> getDeviceRecentActivities(Long deviceId, Integer limit, Long userId) {
        return baseMapper.selectDeviceRecentActivities(deviceId, limit, userId);
    }
