...
public class AdminController {
    ...
    @PutMapping("/farmers")
    @ApiOperation("更新农户信息")
    public Result<?> updateFarmer(@Valid @RequestBody FarmerUpdateDTO dto) {
        farmerService.updateFarmer(dto);
        return Result.ok("农户信息更新成功");
    }
    ...
    @ApiOperation("删除农户")
    public Result<?> deleteFarmer(@ApiParam("农户ID") @PathVariable Long farmerId) {
        farmerService.deleteFarmer(farmerId);
        return Result.ok("农户删除成功");
    }
    ...
    @ApiOperation("更新农户状态")
    public Result<?> updateFarmerStatus(
            @ApiParam("农户ID") @PathVariable Long farmerId,
            @ApiParam("状态：1-正常，0-禁用") @RequestParam Integer status) {
        farmerService.updateFarmerStatus(farmerId, status);
        return Result.ok("农户状态更新成功");
    }
    ...
    @PutMapping("/flyers")
    @ApiOperation("更新飞手信息")
    public Result<?> updateFlyer(@Valid @RequestBody FlyerUpdateDTO dto) {
        userFlyerService.updateFlyer(dto);
        return Result.ok("飞手信息更新成功");
    }
    ...
    @ApiOperation("删除飞手")
    public Result<?> deleteFlyer(@ApiParam("飞手ID") @PathVariable Long flyerId) {
        userFlyerService.deleteFlyer(flyerId);
        return Result.ok("飞手删除成功");
    }
    ...
    @ApiOperation("更新飞手状态")
    public Result<?> updateFlyerStatus(
            @ApiParam("飞手ID") @PathVariable Long flyerId,
            @ApiParam("状态：1-正常，0-禁用") @RequestParam Integer status) {
        userFlyerService.updateFlyerStatus(flyerId, status);
        return Result.ok("飞手状态更新成功");
    }
    ...
    @PutMapping("/owners")
    @ApiOperation("更新机主信息")
    public Result<?> updateOwner(@Valid @RequestBody UserOwnerDTO dto) {
        userOwnerService.updateOwner(dto);
        return Result.ok("机主信息更新成功");
    }
    ...
    @ApiOperation("删除机主")
    public Result<?> deleteOwner(@ApiParam("机主ID") @PathVariable Long ownerId) {
        userOwnerService.deleteOwner(ownerId);
        return Result.ok("机主删除成功");
    }
    ...
    @ApiOperation("更新机主状态")
    public Result<?> updateOwnerStatus(
            @ApiParam("机主ID") @PathVariable Long ownerId,
            @ApiParam("状态：1-正常，0-禁用") @RequestParam Integer status) {
        userOwnerService.updateOwnerStatus(ownerId, status);
        return Result.ok("机主状态更新成功");
    }
