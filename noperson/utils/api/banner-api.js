...
const bannerAPI = {
  ...
  async getBanners(type) {
    ...
    try {
      ...
      const response = await request('/banners', 'GET', {
        type: type
   ...
   */
  getAdminBanners() {
    return request('/admin/banners', 'GET');
  },
   ...
   */
  createBanner(data) {
    return request('/admin/banners', 'POST', data);
  },
  ...
  updateBanner(id, data) {
    return request(`/admin/banners/${id}`, 'PUT', data);
  },
